...
laser_img = load_image('Include/PNG/Lasers/laserBlue06.png')
space_img = load_image('Include/Backgrounds/blue.png')
life_img = load_image('Include/PNG/UI/playerLife2_red.png')
asteroid_images = {
    1: [load_image('Include/PNG/Meteors/meteorGrey_tiny1.png'),
        load_image('Include/PNG/Meteors/meteorGrey_tiny2.png'),
       ],
    2: [load_image('Include/PNG/Meteors/meteorGrey_small1.png'),
        load_image('Include/PNG/Meteors/meteorGrey_small2.png'),
       ],
    3: [load_image('Include/PNG/Meteors/meteorGrey_med1.png'),
        load_image('Include/PNG/Meteors/meteorGrey_med2.png'),
       ],
    4: [load_image('Include/PNG/Meteors/meteorGrey_big1.png'),
...
exhaust_images = []
for i in range(25):
    name = 'Include/PNG/White puff/whitePuff{:02}.png'.format(i)
...
pyglet.font.add_file('Include/Sounds/kenvector_future_thin.ttf')
